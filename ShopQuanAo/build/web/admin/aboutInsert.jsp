                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form name="aboutInsert" onsubmit="return validateForm()" class="row" action="aboutmanager" method="POST" >
                        ...
                        <script>
                                                ...
                                                let title = document.forms["aboutInsert"]["about_title"].value.trim();
